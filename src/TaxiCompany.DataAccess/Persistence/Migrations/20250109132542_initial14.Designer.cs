...
namespace TaxiCompany.DataAccess.Persistence.Migrations
{
    ...
    [Migration("20250109132542_initial14")]
            ...
            modelBuilder.Entity("TaxiCompany.Core.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 1, 9, 13, 25, 40, 957, DateTimeKind.Utc).AddTicks(3591),
                            Email = "saydshox123@gmail.com",
                            FirstName = "Shoxruz",
                            PasswordHash = "12345",
                            Role = 1,
                            Salt = "89682781-497a-4300-b308-5f4623591cfc"
                        });
                });
