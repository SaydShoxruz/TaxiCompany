...
namespace TaxiCompany.DataAccess.Persistence.Migrations
{
    ...
    [Migration("20250109132732_initial15")]
            ...
            modelBuilder.Entity("TaxiCompany.Core.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 1, 9, 13, 27, 30, 759, DateTimeKind.Utc).AddTicks(2531),
                            Email = "saydshox123@gmail.com",
                            FirstName = "Shoxruz",
                            PasswordHash = "12345",
                            Role = 1,
                            Salt = "c4ad6ec8-4247-4ec7-ba7e-4a51e36710b6"
                        });
                });
