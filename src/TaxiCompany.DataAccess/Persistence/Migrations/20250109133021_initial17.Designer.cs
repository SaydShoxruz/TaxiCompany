...
namespace TaxiCompany.DataAccess.Persistence.Migrations
{
    ...
    [Migration("20250109133021_initial17")]
            ...
            modelBuilder.Entity("TaxiCompany.Core.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 1, 9, 13, 30, 20, 892, DateTimeKind.Utc).AddTicks(5109),
                            Email = "saydshox123@gmail.com",
                            FirstName = "Shoxruz",
                            PasswordHash = "12345",
                            Role = 1,
                            Salt = "2eac8702-4d82-4b98-85c4-eda1ce3f23a4"
                        });
                });
